		...
		while (checkOut) {
			...
			case 1:
				if (product1.getProdStock() <= 0) {
					System.out.println();
					System.out.println(product1.getProdName() + " is out of stock, please buy one of our other products.");
					break;
				}else {
			...
			case 2:
				if (product2.getProdStock() <= 0) {
					System.out.println();
					System.out.println(product2.getProdName() + " is out of stock, please buy one of our other products.");
					break;
				}else {
			...
			case 3:
				if (product3.getProdStock() <= 0) {
					System.out.println();
					System.out.println(product3.getProdName() + " is out of stock, please buy one of our other products.");
					break;
				}else {
